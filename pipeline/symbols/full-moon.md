...
symbol: full-moon
name: FULL MOON
strongs: [H3677, H3842, H3394]
words: ["full moon", "time appointed", "keseh", "levanah", "moon"]
role: noun-symbol
meaning: The appointed day of the king's return — the moon at fullness (H3677 keseh, from H3680 kasah = fill), sharing its root with THRONE (H3678 kissé). The full moon marks the mo'edim feasts (15th), the shofar blast, and the bridegroom's return.
opposite: NEW MOON (H2320 chodesh = concealed/renewal)
defining_verses: [Ps 81:3, Prov 7:20, Mat 24:27, Josh 10:12-13, Zech 14:7, Joel 2:31, Song 6:10]
...
**H3677 keseh** = "fulness or full moon, its festival" from H3680 kasah = fill up/cover. SAME ROOT as H3678 kissé = THRONE. Full moon = moon enthroned = king takes his seat. KJV hides this — translates as "time appointed" in both occurrences. SLT/JPS/DRB/DBT all render "full moon."

**ONLY 2 OCCURRENCES OF H3677:**
Ps 81:3 — Blow SHOFAR at new moon + at FULL MOON (H3677) on solemn feast day. co: TRUMPET (H7782). Statute + law + testimony since Exodus (vv4-5). Full moon = 15th = Passover/Tabernacles. SHOFAR+FULL MOON bound in same command → last trump at full moon.

Prov 7:20 — Husband returns at day of FULL MOON (H3677). co: SILVER (H3701 keseph = money/price). Husband departs with silver, returns at keseh. = Dan 9:26 alt: Messiah cuts covenant, vanishes, returns. = Jn 14:2-3 groom departs to prepare place. BRIDE knows the season (full moon) but not exact day/hour (Mat 24:36).

**CELESTIAL PHENOMENA REQUIRING FULL MOON:**
Mat 24:27 — G796 astrape = "lightning; by analogy, GLARE/bright shining." Full moon rises east, light shines west all night. Only celestial body that does this. NOT random lightning.
Josh 10:12-13 — Sun+moon BOTH visible, opposite sides of sky. Sun on Gibeon (W), moon in Ajalon (E). Opposition = full moon only.
Hab 3:11 — Sun+moon stood still. Same full-moon requirement. Prophetic template for day of judgment.
...
**Ps 89:37** — Moon = FAITHFUL WITNESS (H539 aman). Full moon = maximum reflection = maximum witness. Bride (Song 6:10) reflects the Son as moon reflects sun.

**Ps 104:19** — Moon appointed for MO'EDIM (H4150 = appointed times/festivals). Full moon (15th) = Passover + Tabernacles. Moon IS the covenant clock.
