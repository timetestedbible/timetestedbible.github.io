---
symbol: gospel-of-kingdom
name: GOSPEL OF THE KINGDOM
strongs: [G2098, G2097, G932, G2784, G3142, G3141, G3144, G5055, G5056]
words: ["gospel", "gospel of the kingdom", "preach", "witness", "testimony", "martyr", "finish", "end"]
role: noun-symbol
meaning: the herald-announcement that God's covenant reign has arrived — preached as legal testimony (marturion) to all nations, whose COMPLETION triggers the end (telos)
opposite: DECEIVE (false gospel / false prophets)
...
- **G2098 euangelion** — "a good message, i.e. the gospel." From G2097 euangelizo (to announce good news), from G2095 eu (well) + G32 aggelos (messenger). KJV: "gospel." 77 NT occurrences.
- **G2097 euangelizo** — "to announce good news ('evangelize') especially the gospel." The verb form. KJV: "declare, bring glad tidings, preach (the gospel)."
- **G932 basileia** — "properly, royalty, i.e. (abstractly) rule, or (concretely) a realm." From G935 basileus (king). KJV: "kingdom, reign." 162 NT occurrences.
- **G2784 kerusso** — "to herald (as a public crier), especially divine truth." KJV: "preach, proclaim, publish." The mode of delivery: official herald-proclamation, not casual sharing.
- **G3142 marturion** — "something evidential, i.e. evidence given; specially, the Decalogue (in the sacred Tabernacle)." From G3144. KJV: "testimony, witness." 20 NT occurrences.
- **G3141 marturia** — "evidence given (judicially or genitive case)." From G3144. KJV: "record, report, testimony, witness." 37 NT occurrences.
- **G3144 martus** — "a witness (literally, judicially, or figuratively); by analogy, a 'martyr'." KJV: "martyr, record, witness." ROOT of both marturion and marturia. Witness→martyr semantic evolution = the cost of testimony.
- **G5055 teleo** — "to end, i.e. complete, execute, conclude, discharge (a debt)." From G5056 telos. KJV: "accomplish, finish, make an end, expire, fill up, pay, perform."
- **G5056 telos** — "the point aimed at as a limit; the conclusion of an act or state; purpose; an impost/levy." KJV: "end, custom, finally, uttermost."
...
4. **Triple-ministry structure:** Mat 4:23 and 9:35 establish: teach (didasko) + herald (kerusso) + heal (therapeuo). The gospel of the kingdom isn't just a message — it's a ministry-triad. Teaching conveys content, heralding proclaims authority, healing demonstrates power. All three together = the kingdom arriving. Post-resurrection: Acts 28:31 retains teaching+preaching but healing is absorbed into resurrection-witness (Acts 4:33).
5. **Beast acts ONLY after testimony finishes:** Rev 11:7 — the beast from the abyss CANNOT kill the witnesses until their testimony is teleo'd. The witness-period is PROTECTED. Only completion of the appointed testimony opens the door to the beast's assault. This mirrors Mat 26:31 — Jesus wasn't arrested until he declared "all ye shall be skandalizo'd" (testimony finished → persecution released). Pattern: protected witness → testimony-completion → persecution/death → resurrection → authority.

**Convergence with SKANDALIZO:** Mat 24:9-14 is a unified sequence: persecution (v9) → skandalizo (v10) → false prophets/DECEIVE (v11) → WICKEDNESS multiplies (v12) → endurance = salvation (v13) → gospel-of-kingdom testimony completed (v14) → THEN the end. Skandalizo is the COST of the marturion. The pressure that causes the rootless to fall is the SAME pressure that refines the faithful into witnesses. Dan 11:33-35 confirms: the wise instruct many AND fall by sword — stumbling purifies to the time of the end.
