...
words: ["sword", "swords", "flaming sword", "two-edged sword"]
role: noun-symbol
meaning: Instrument of desolation — the cutting/destroying agent that produces drought, waste, and death. Root H2717 charab = to parch, desolate, destroy. The sword IS the desolation-maker.
opposite: PLOWSHARE (Isa 2:4, Joel 3:10 — swords↔plowshares = destruction↔cultivation)
defining_verses: [Gen 3:24, Isa 34:5-6, Rev 19:15, Heb 4:12, Jer 15:3, Deut 32:41-42, Ezek 21:9-17]
co_occurring: [FIRE, FAMINE, PESTILENCE, DESOLATION, BLOOD, BABYLON, THORNS, HEAVEN, CURSE]
context_types: [narrative, prophetic oracle, apocalyptic, wisdom, discourse]
rev: 1
churn: 1.00
inputs: {symbols/babylon: [2, 1.60], symbols/fire: [1, 1.00], symbols/flying-scroll: [0, 1.00]}
...
Isa 34 sequence: nations summoned → cherem on all → mountains melt → heavens roll → sword descends
Result: streams → pitch, dust → brimstone, unquenchable fire, perpetual smoke
Compare: 2 Pet 3:10 elements melt || Rev 18:9 smoke || Rev 14:11 eternal torment

Mat 24:4-8 — Jesus substituted earthquake for sword in Jeremiah triad
Sword enters v9, escalates through vv21-22. Early = structural violence, later = personal

Isa 34:13 — THORNS in palaces after cherem-sword-fire judgment
Worldly cursed people overrun ruins post-destruction

**Pattern:** Cherem (total destruction) delivered by sword bathed in heaven → fire/brimstone → smoke forever
Modern weapon profile: space-trajectory + devastating impact + fire effects + lasting consequences