...
> *Now the children of Israel camped in Gilgal, and kept t**he Passover on the 14th day****of the month at twilight on the plains of Jericho. And they* ***ate of the stored produce (from prior year) of the land on the day after the Passover (15th)****, unleavened bread and parched grain, on the very same day. Then the* ***manna ceased on the day after they had eaten the stored produce of the land (day after 15th is 16th)***; and the children of Israel no longer had manna, but they ate the food of the land of Canaan that year.*
> — Joshua 5:10-12
...
> — Leviticus 23:15-16 ([LXX](/reader/bible/lxx/Leviticus/23))
...
In fact, the law states the equation itself, by parallel statute: the very count Leviticus 23:15 gives as "seven **sabbaths** shall be complete," Deuteronomy 16:9 gives as "seven **weeks** shalt thou number" — same command, same festival, same count, *sabbath* in one book and *week* in the other. And the word scales the way only a unit can: "thou shalt number seven **sabbaths of years**... seven times seven years" (Leviticus 25:8) — a "sabbath of years" is arithmetically a whole 7-year span, not a rest-year.

The Greek of the New Testament talks the same way, and translation has hidden it. The Pharisee's boast "I fast twice **in the week**" (Luke 18:12) is literally *dis tou sabbatou* — twice **in the sabbath**; no man fasts twice in a day. Every "first day of the week" in the resurrection accounts is literally "one **of the sabbaths**" (*mia sabbatōn* — Matthew 28:1; Mark 16:2; Luke 24:1; John 20:1; Acts 20:7; 1 Corinthians 16:2). Matthew 28:1 even holds both senses in a single verse — "in the end of the **sabbath** [the day]... toward the first day of the **week** [literally: one of the sabbaths]" — the same Greek word twice, and the King James itself renders the second occurrence "week." The word named the seven-unit in the mouths of first-century speakers; the seventh day is the unit's crown.
...
Push that observation one step further and it becomes an argument on its own. On a continuous, unbroken weekly cycle, a count of sevens that *begins on the day after a sabbath* cannot possibly produce an incomplete seven — every block of seven days from that starting point automatically contains exactly one sabbath. On that calendar the qualifier "complete" (*temimot* — the same word the law uses for an unblemished sacrifice) would legislate nothing at all; it would be a dead word, and the law does not spend words on impossibilities. "Complete" only has work to do in a reckoning where a broken seven is *possible* — that is, where some days stand outside the weeks entirely. The qualifier itself presupposes the very structure the continuous-week tradition denies.
...
Notice what the count actually is, structurally: it is specified **three ways at once** — a fixed start (the sheaf on the 16th, "the morrow after the sabbath"), a unit-count ("seven sabbaths shall be complete"), and a landing condition ("unto the morrow after the seventh sabbath shall ye number fifty days"). That is over-determination with a purpose. It is the same redundancy that protects the text everywhere — corrupt one witness and the others convict the change — here applied to *time*: the true calendar satisfies all three specifications silently, every year, and every altered calendar is convicted by its own arithmetic in at least one of them. The omer count is a checksum on the calendar, and the two-thousand-year-old dispute is the checksum failing exactly where it was designed to fail.

Now that I have made my case, here is the supporting primary evidence for First Fruits always being on the 16th.

**The [Septuagint (LXX)](/reader/bible/lxx/Leviticus/23)** translation specifies the timing of the First Fruits sheaf offering as occurring on the "morrow of the first day" (implying the day after the first day of the Feast of Unleavened Bread, or the 16th of the first month).
...
> — Leviticus 23:9–16 [LXX](/reader/bible/lxx/Leviticus/23)
