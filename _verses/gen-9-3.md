...
layout: verse-study
verse_key: gen-9-3
title: "Genesis 9:3 — Verse Study"
short_title: "Every Moving Thing Shall Be Food?"
description: "Spoken to Noah — who already distinguished clean from unclean by sevens. 'As the green herb' parallels the plant designation of Genesis 1:29, delegating within God's categories, not abolishing them."
verse_ref: "Gen 9:3"
...
1. **Noah already distinguished clean from unclean** (Gen 7:2) by God's direct instruction — one chapter before Gen 9:3.
2. **"As the green herb"** is a parallel expansion — plants were designated as food (Gen 1:29); now animals are added (Gen 9:3) — within God's categories, not without limit.
3. **Blood is immediately restricted** (Gen 9:4) — proving the permission has boundaries from the start.
4. **The distinction predates Sinai** — it was not invented for Israel. It is a creation-order distinction preserved through Noah and codified in detail at Sinai.
