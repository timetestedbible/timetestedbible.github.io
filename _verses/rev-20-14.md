...
Every other "lake of fire" passage in the Hebrew Revelation uses **Sheol** — the demanding place, the realm of the dead (Rev 19:20, 20:10, 21:8). But here, and ONLY here, the Hebrew switches to **Gehinnom**.
...
The word switch matters: in v.13, "$sheol gave up the dead" — the demanding place releases its captives. Then in v.14, "Gehinnom was cast into the fire" — the judgment concept is destroyed. Two different Hebrew words for two different things being ended. Sheol (the holding cell) gives up its dead. Gehinnom (the judgment) is consumed. Both are finished.
...
| H7585 | *sheol* | the demanding place — used elsewhere; here it is what's being destroyed |
