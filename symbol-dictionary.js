...
const SYMBOL_DICTIONARY = {
  ...
  'assembly': {
    ...
    strongs: [],
    meaning: 'A counterfeit congregation claiming covenant standing while gathered against the covenant\'s Lord. Korah\'s company; the brood of vipers and children of the Devil, the father of lies; the assembly surrounding the Messiah; and those who say they are Jews but are not display the pattern. This is a spiritual identity defined by allegiance and rejection of Messiah, never by ancestry.',
    sentence: 'A counterfeit congregation claiming covenant standing while gathered against the covenant\'s Lord. Korah\'s company; the brood of vipers and children of the Devil, the father of lies; the assembly surrounding the Messiah; and those who say they are Jews but are not display the pattern. This is a spiritual identity defined by allegiance and rejection of Messiah, never by ancestry.',
    opposite: null,
    rank: 4.8,
    category: 'Uncategorized',
    subcategory: null,
  ...
  'blind': {
    ...
    sentence: 'A person unable to understand the word of God because his eyes have been closed — first by his own doings (love of bribes, trust in idols, an evil eye toward the poor, hatred, refusing to hear the law), and at last by God\'s judgment, who blinds the persistent refuser as He hardened Pharaoh\'s heart. The eye is a lamp and the commandment is a lamp — "the commandment of the LORD is pure, enlightening the eyes" — and the blind man lacks the eyes to see it. The condition is healed only by repentance and faith in Jesus: "when it shall turn to the Lord, the vail shall be taken away."',
    opposite: null,
    rank: 0,
    category: 'Judgment & Consequence',
    subcategory: null,
  ...
  'fear': {
    ...
    strongs: [],
    meaning: 'Reverent awe that produces obedience: it turns a person from evil and toward the LORD\'s commandments.',
    sentence: 'Reverent awe that produces obedience: it turns a person from evil and toward the LORD\'s commandments.',
    opposite: null,
    rank: 4.9,
    category: 'Uncategorized',
    subcategory: null,
  ...
  'harlot': {
    ...
    strongs: ['H2181', 'G4204'],
    meaning: 'A covenant city or people unfaithful to its Husband while retaining the outward form of covenant. In Revelation, the Harlot is the great city that rules over kings — spiritually named Sodom and Egypt, branded on her forehead with the name of the beast she rides, Babylon — literally Jerusalem, where Jesus and the prophets were killed.',
    sentence: 'A covenant city or people unfaithful to its Husband while retaining the outward form of covenant. In Revelation, the Harlot is the great city that rules over kings — spiritually named Sodom and Egypt, branded on her forehead with the name of the beast she rides, Babylon — literally Jerusalem, where Jesus and the prophets were killed.',
  ...
  'sabbath': {
    ...
    words: ['sabbath'],
    strongs: [],
    meaning: 'A complete seven crowned by rest — the week itself, and the unit at every scale the law counts: the land\'s seventh year, the seven sevens to Jubilee. Hebrew counts "seven sabbaths" (shabbatot) where Deuteronomy counts the same span as "seven weeks" (shavuot); Greek calls the week the sabbath — "twice in the sabbath" (dis tou sabbatou) is twice a week, and every "first day of the week" is "one of the sabbaths" (mia sabbatōn). The rest is the completing member of the whole unit.',
    sentence: 'A complete seven crowned by rest — the week itself, and the unit at every scale the law counts: the land\'s seventh year, the seven sevens to Jubilee. Hebrew counts "seven sabbaths" (shabbatot) where Deuteronomy counts the same span as "seven weeks" (shavuot); Greek calls the week the sabbath — "twice in the sabbath" (dis tou sabbatou) is twice a week, and every "first day of the week" is "one of the sabbaths" (mia sabbatōn). The rest is the completing member of the whole unit.',
    opposite: null,
    rank: 4.8,
    category: 'Uncategorized',
    subcategory: null,
  ...
  'sapphire': {
    ...
    words: ['sapphire'],
    strongs: [],
    meaning: 'The full moon in its enthroned and bridal form — the clear sapphire likeness at the place of God\'s throne, whose rare “clearness” (tohar, Exodus 24:10) is the very word for the throne-glory that can be made to cease (Psalm 89:44): a brightness worn, not owned. Identified with Issachar.',
    sentence: 'The full moon in its enthroned and bridal form — the clear sapphire likeness at the place of God\'s throne, whose rare “clearness” (tohar, Exodus 24:10) is the very word for the throne-glory that can be made to cease (Psalm 89:44): a brightness worn, not owned. Identified with Issachar.',
    opposite: null,
    rank: 4.8,
    category: 'Uncategorized',
    subcategory: null,
  ...
  'seed': {
    ...
    words: ['seed'],
    strongs: [],
    meaning: 'A generative word or life planted to reproduce after its kind. In the sower it is God\'s word; in the wheat and tares it is children; the promised Seed is Messiah; and one planted person may grow into a house, people, or nation-tree.',
    sentence: 'A generative word or life planted to reproduce after its kind. In the sower it is God\'s word; in the wheat and tares it is children; the promised Seed is Messiah; and one planted person may grow into a house, people, or nation-tree.',
    opposite: null,
    rank: 4.8,
    category: 'Uncategorized',
    subcategory: null,
  ...
  'sign': {
    ...
    words: ['sign'],
    strongs: [],
    meaning: 'A marked witness by which God makes His word known: either a prophetic word, scene, or lived similitude given in advance, whose fulfillment testifies; or a visible covenant token that bears continuing witness to an established word. Neither sense requires a wonder performed on demand.',
    sentence: 'A marked witness by which God makes His word known: either a prophetic word, scene, or lived similitude given in advance, whose fulfillment testifies; or a visible covenant token that bears continuing witness to an established word. Neither sense requires a wonder performed on demand.',
    opposite: null,
    rank: 4.8,
    category: 'Uncategorized',
    subcategory: null,
  ...
  'tree': {
    ...
    meaning: 'A rooted covenant life known by its fruit, growing in scale from one planted seed or person into a house, lineage, people, or nation. The mature branches are members and may shelter others; the fruit becomes seed for further growth.',
    sentence: 'A rooted covenant life known by its fruit, growing in scale from one planted seed or person into a house, lineage, people, or nation. The mature branches are members and may shelter others; the fruit becomes seed for further growth.',
  ...
  'trumpet': {
    ...
    meaning: 'The proclamation of ruling authority',
    sentence: 'The proclamation of ruling authority — the sound by which a king\'s word takes public effect: assembly, war, release, coronation. At the hinge texts the blast itself makes the transfer — and the horn of Sinai, of Jericho, and of the Jubilee is one Hebrew word: the yovel.',
