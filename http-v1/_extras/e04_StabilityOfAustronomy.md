...
1. **Certainty of Independent Date**: How certain are we of the date from historical records alone (without astronomical calculations)?
2. **Stellarium Match Quality**: How well does Stellarium's retrocalculation match the historical record (path, timing, visibility)?
3. **Uniqueness**: How likely is it that there are multiple potential matches (could other dates also fit the description)?
