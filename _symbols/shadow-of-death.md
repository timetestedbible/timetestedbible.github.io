...
definitions:
  ...
  bible_literal:
    ...
    citations:
      ...
      - Jer 2:6
  webster:
    text: Darkness or gloom like that caused by the presence or the impending of death.
    status: quoted
    headword: SHADOW
...
A literal shadow shares the outline of the body casting it. Scripture transfers
that structure to symbolic objects and enacted activities: the shadow has the
shape of its substance. It can therefore speak of the shadow of the Almighty,
the shadow of Christ, the shadow of Egypt, or the shadow of Death. The grammar
itself asks the decisive question: **whose shadow, and what substance gives it
shape?**

Death's shadow is not merely a frightening mood. Job calls it a *land* with
doors and places those doors beside the gates of death (Job 10:21-22; 38:17).
Jeremiah joins it to deserts and pits (Jer 2:6). Psalm 107 places people within
it, bound in affliction and iron, then says God brings them **out** and breaks
their bands (Ps 107:10, 14). It behaves like a dominion under which people sit,
walk, and remain captive.

The prophets also insist that it is not the final dominion. God turns the
Shadow of Death into morning (Amos 5:8). Light springs upon those sitting under
it (Isa 9:2; Matt 4:16), and the Dayspring visits *“to give light to them that
...
The Shadow of Death is closely related to $sheol, the pit, and the grave, but it
is not automatically an alias for any one of them.

- Job describes a land of Shadow of Death from which he expects no return (Job
  10:21-22).
- The gates of death stand parallel to the doors of Shadow of Death (Job
  38:17).
- Jeremiah's wilderness contains deserts, pits, drought, and Shadow of Death
  in one landscape (Jer 2:6).
...
Psalm 23 combines two symbols without making them interchangeable:
...
- **$shadow** — supplies the shared rule: the outline and reach take their
...
| Proposed meaning | What it explains | What it misses |
|---|---|---|
...
The KJV prints *shadow of death* for H6757 in **17 Old Testament verses**:

**Job:** 3:5; 10:21-22; 12:22; 16:16; 24:17; 28:3; 34:22; 38:17

**Psalms:** 23:4; 44:19; 107:10, 14
...
Isaiah 9:2 is carried into Matthew 4:16, and Luke 1:79 independently joins the
same Greek phrase to light and the Way of peace.

## Corpus and Method

This study begins with all seventeen KJV Old Testament uses of H6757 printed as
*shadow of death*, then follows the phrase into Matthew 4:16 and Luke 1:79. It
tests the proposed senses against the phrase's land, gates, pit, bondage,
light, Way, and deliverance language rather than treating Psalm 23 in
isolation.
