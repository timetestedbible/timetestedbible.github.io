...
record_type: symbol
symbol_key: butter
term: Butter (curdled milk)
title: Butter (curdled milk) — Symbol Research
description: >-
  A Scripture-first study of Butter (curdled milk): The word worked from milk into sound judgment —
  teaching tested until one can refuse evil and choose good. Worked into the walk, it cleanses the
  feet; its counterfeit is smooth speech concealing war.
words:
  - butter
definition: >-
  The word worked from milk into sound judgment — teaching tested until one can refuse evil and
  choose good. Worked into the walk, it cleanses the feet; its counterfeit is smooth speech
  concealing war.
meaning: >-
  The word worked from milk into sound judgment — teaching tested until one can refuse evil and
  choose good. Worked into the walk, it cleanses the feet; its counterfeit is smooth speech
...
definition_meta:
  ...
  status: approved
  source: books/symbolic-language/49-glossary.adoc#sym-butter
  verdict: novel
...
research:
  status: documented
  source_files:
    - books/symbolic-language/research/research-butter.md
  corpus:
...
definitions:
  ...
  webster:
    text: An oily, unctuous substance obtained from cream or milk by churning.
    status: quoted
    headword: BUTTER
...
The book defines butter allegorically as 'the word churned solid' or 'sound doctrine' produced by labor, which provides moral discernment and spiritual nourishment.
...
Webster's 1913 entry for **butter** begins:
...
- The cited verses contain churning, food, discernment, remnant survival, prosperous imagery, and smooth deceptive speech, but they do not themselves identify butter with sound doctrine. Proverbs 30:33 explicitly uses churning as an analogy for provoked strife, while Isaiah 7’s phrase may mark the child’s age or circumstances rather than doctrine taught by eating butter.

- One could argue REFINED: the book's reading is anticipated by Response C's rare 'spiritual nourishment/mature teaching' alternative, and the consensus itself concedes no settled meaning, so elevating a recognized (if rare) alternative might be seen as selecting within the consensus field rather than contradicting it. The Isaiah 7:15 KJV wording also literally links the butter diet to moral discernment, giving the book's core some direct textual footing.

- The claim that butter symbolizes 'the word churned solid' relies on an external allegorical premise (milk = the Word; churning = doctrinal labor) rather than the texts themselves. Proverbs 30:33 explicitly uses the churning of milk as a metaphor for forcing wrath to produce strife, not laboring to produce sound doctrine.
...
Related definitions used by this entry: [milk](/research/symbols/milk/).

## Occurrence Register

<details markdown="1">
<summary>Show the complete 10-verse English-form register</summary>
