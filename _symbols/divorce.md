...
record_type: symbol
symbol_key: divorce
term: Divorce (bill of divorcement)
title: Divorce (bill of divorcement) — Symbol Research
description: >-
  A Scripture-first study of Divorce (bill of divorcement): A covenant severed and the wife sent
  from the house — exile and scattering. Scripture distinguishes treacherous divorce from separation
  out of a union God never joined.
words:
  - divorce
definition: >-
  A covenant severed and the wife sent from the house — exile and scattering. Scripture
  distinguishes treacherous divorce from separation out of a union God never joined.
meaning: >-
  A covenant severed and the wife sent from the house — exile and scattering. Scripture
  distinguishes treacherous divorce from separation out of a union God never joined.
...
definition_meta:
  ...
  status: approved
  source: books/symbolic-language/49-glossary.adoc#sym-divorce
  verdict: standard
...
definitions:
  ...
  webster:
    text: >-
      (Law) (a) A legal dissolution of the marriage contract by a court or other body having
      competent authority.
    status: quoted
    headword: DIVORCE
...
The covenant lawsuit executed as the wife sent out of the house (exile and scattering); hated when it betrays the covenant wife, but commanded when the union is fornication (a marriage God never joined); God gave Israel the bill and answered His own no-return rule at the cross.
...
Webster's 1913 entry for **divorce** begins:
...
This study checks the glossary's defining citations first, then compares them with every KJV verse that prints *divorce*. The English-form sweep found **1 verse**. It is exhaustive for those printed forms, but it is not a substitute for a Strong's-number sweep where several Hebrew or Greek words share one English translation.
...
- Jeremiah 3:8, Isaiah 50:1, and Deuteronomy 24 directly support the divorce metaphor and no-return rule, while Ezra 10 and Malachi 2 support contrasting forms of putting away. However, the printed references do not themselves state that Ezra’s unions were marriages God never joined, nor do they cite a New Testament text establishing that the cross answered Deuteronomy’s remarriage prohibition. The entry’s most distinctive conclusion therefore exceeds its printed citation base.

- One could argue MATCH: the core is identical, the cross-resolution claim is already catalogued as a listed minority alternative in Response A, and the Malachi 2/Ezra 10 material could be read as immaterial ethical detail rather than a change to the symbol's extension. If the dual-valence and cross claims are treated as elaboration rather than boundary change, the differences reduce to detail.

- The integration of the 'no-return rule at the cross' may be viewed as a highly specific, systemic theological construct (Two-House or specific typological framework) rather than the direct, primary symbolic meaning of the prophetic divorce motif itself.
...
The glossary names **Marriage.** as the reciprocal opposite. That relation must work in both directions; a merely related image is not an opposite.

Related definitions used by this entry: [covenant](/research/symbols/covenant/), [Marriage](/research/symbols/marriage/).

## Occurrence Register

<details markdown="1">
<summary>Show the complete 1-verse English-form register</summary>
