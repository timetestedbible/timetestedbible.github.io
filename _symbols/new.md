...
symbol_key: new
term: New name
title: New name — Symbol Research
description: >-
  A Scripture-first study of New name: A renewed Word, covenant, and priesthood — known, received,
  and kept only by the one who bears the renewed Name.
words:
  - new name
definition: >-
  A renewed Word, covenant, and priesthood — known, received, and kept only by the one who bears the
  renewed Name.
meaning: >-
  A renewed Word, covenant, and priesthood — known, received, and kept only by the one who bears the
  renewed Name.
...
definition_meta:
  ...
  status: approved
  source: books/symbolic-language/49-glossary.adoc#sym-new
  verdict: divergent
...
senses:
  - id: approved-core
    status: approved
    summary: >-
      A renewed Word, covenant, and priesthood — known, received, and kept only by the one who bears
      the renewed Name.
    citations:
      - Gen 32:28
      - Isa 62:2-5
...
The “new name” is the renewed covenant itself, privately known and kept by its recipient.
...
Related definitions used by this entry: [covenant](/research/symbols/covenant/), [Name](/research/symbols/name/).
