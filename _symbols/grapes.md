...
symbol_key: grapes
term: Grapes
title: Grapes — Symbol Research
description: >-
  A Scripture-first study of Grapes: A people's works ripened into persons as the vineyard's yield.
  Pressed grapes produce covenant wine or the blood of judgment according to whether the vintage is
  good or wild.
words:
  - grapes
definition: >-
  A people's works ripened into persons as the vineyard's yield. Pressed grapes produce covenant
  wine or the blood of judgment according to whether the vintage is good or wild.
meaning: >-
  A people's works ripened into persons as the vineyard's yield. Pressed grapes produce covenant
  wine or the blood of judgment according to whether the vintage is good or wild.
...
definition_meta:
  ...
  status: approved
  source: books/symbolic-language/49-glossary.adoc#sym-grapes
  verdict: standard
...
research:
  status: documented
  source_files:
    - books/symbolic-language/research/research-grapes.md
  corpus:
...
definitions:
  ...
  webster:
    text: >-
      (Bot.) Defn: A well-known edible berry growing in pendent clusters or bunches on the
      grapevine.
    status: quoted
    headword: GRAPE
...
Grapes represent a nation's works manifested in its people (individuals, the remnant), and when pressed, they yield blood that represents either the cup of the covenant or the cup of divine wrath.
...
Webster's 1913 entry for **grape** begins:
...
- A strong case for MATCH is that the consensus explicitly cites Hosea's identification of Israel with grapes and Micah's missing cluster as the absence of a righteous person, while also covering covenant blood and wrath. The refinement classification depends on treating the book's works-to-persons distinction as a material boundary claim rather than merely compressed wording. Additionally, the printed references strongly support people, remnant, righteousness, blood, and wrath, but do not directly establish the covenant-cup application.

- One could argue MATCH: the book merely combines two elements already present in the consensus (fruitfulness expected of Israel + Israel/people-as-grapes alternative + wrath and covenant-blood strands), so the 'persons as yield' formulation is stylistic synthesis rather than a material change of extension. Alternatively, one could argue the identification of grapes specifically as persons (the good man as the cluster, the remnant in the cluster) goes beyond what any single consensus response asserts as primary, making the reclassification more substantive than a refinement.

- The book formulates the concept as 'works ripened into its people,' which is a highly specific poetic rendering compared to the broader 'spiritual fruitfulness' of the consensus. However, this is just a phrasing difference, as both rely on the exact same Isaiah 5 and Micah 7 referents for their core meaning.
...
Related definitions used by this entry: [covenant](/research/symbols/covenant/), [judgment](/research/symbols/judgment/).

## Occurrence Register

<details markdown="1">
<summary>Show the complete 33-verse English-form register</summary>

**Genesis:** 40:10, 40:11, 49:11

**Leviticus:** 25:5, 25:11

**Numbers:** 6:3, 13:20, 13:23, 13:24

**Deuteronomy:** 23:24, 24:21, 28:30, 28:39, 32:32

**Judges:** 8:2, 9:27

**Nehemiah:** 13:15

**Song of Solomon:** 2:15, 7:7

**Isaiah:** 5:2, 5:4, 17:6, 24:13

**Jeremiah:** 8:13, 25:30, 49:9
