...
Consider the context is “ascending above the heights of the clouds”, we are clearly not referring to a spiritual realm in this paragraph.
...
The moon is “the faithful witness in heaven” (Psalm 89:37) — and Yeshua is “the faithful witness” (Revelation 1:5), the same title.
...
Yeshua calls His followers “children of light and children of the day” — “we are not of the night, nor of darkness” (1 Thessalonians 5:5).
...
image::images/masters/lucifers-declared-plan-fig1-p123.jpg["Figure from the print edition (pdf p. 123); placement to be confirmed against the PDF",pdfwidth=85%,align=center]
