...
order: 19.1
permalink: /books/time-tested-tradition/first-fruits-new-wine/
published: false
edition: digital
description: "Explores the timing and significance of First Fruits and the Feast of New Wine in relation to the calendar. This extra chapter provides additional evidence for calendar determination."
---
...
The Septuagint (LXX) rendering of Exodus 32:18 provides a key insight into the wine-focused inauguration:
...
+
[quote.scripture, Leviticus 23:13]
____
