...
image::images/masters/stability-of-astronomy-fig1-p282.jpg["Figure from the print edition (pdf p. 282); placement to be confirmed against the PDF",pdfwidth=85%,align=center]
