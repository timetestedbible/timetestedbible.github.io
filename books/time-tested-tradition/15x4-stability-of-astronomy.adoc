...
The Passover moons of 30–33 AD, the eclipse before Herod's death, the morning of the Jordan crossing — each argument ends with a computed position of the sun or the moon on a named ancient morning.
...
Three questions grade each witness: How certain is its date from the records alone? How well does the computed sky match what was written down — path, timing, and visibility? How unique is the match — could any other date fit the same description?
...
Stellarium supplies the ground truth for when the sun and moon actually stand at those stations on a Renewed Moon Day — first light after the full moon, the waning moon still 12–24° above the western horizon:
...
The deltas are measured from the surveyed stations — 117.29° to Gibeon and 245.68° to Aijalon, with the northward skew of the moon's setting arc — and every one stays inside 7°: the computed sky of 1405 BC puts the two lights exactly where Joshua's prayer posts them, the sun barely risen, the waning moon still standing in the west.
...
Its cycles were promised in Genesis 8:22, its record was verified against observers who died 4,000 years ago, and its testimony reaches every date these chapters compute.
...
.The stations of Joshua's long day: from Upper Beth Horon the sun stands over Gibeon (Al Jib) at ~117° and the moon over the valley of Aijalon at ~246° — the two lights in near opposition (Joshua 10:12)
image::images/masters/stability-of-astronomy-fig1-p282.jpg["Map of the surveyed long-day stations: Gibeon and the valley of Aijalon from Upper Beth Horon",pdfwidth=85%,align=center]
