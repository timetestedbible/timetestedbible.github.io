...
Stellarium supplies the test.
At dawn on the Renewed Moon Day of January 23, 1405 BC — first light after the full moon — the sun rises at azimuth 118°, 0.7° from the surveyed line to Gibeon, and the waning moon stands 1.7° from the line to Aijalon once the northward skew of its setting arc is counted.
The computed sky puts the two lights exactly where Joshua's prayer posts them, the sun barely risen, the moon still standing in the west.
...
The text that seemed to break the clock turns out to be readable *on* the clock: a commanded silence of the two lights at surveyed stations, on a datable morning.
