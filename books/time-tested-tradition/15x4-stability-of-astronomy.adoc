...
Joshua's prayer—"Sun, stand still at Gibeon, and you, moon, over the Valley of Aijalon"—is idiomatic, rooted in ANE omen practices where bodies "standing still/silent" (Hebrew _damam_) were positioned as a divine sign.
...
The moon orbits in the same direction as Earth's rotation but far slower, so visibility timing differs from initial assumptions.
