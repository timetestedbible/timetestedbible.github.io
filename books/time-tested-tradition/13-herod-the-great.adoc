...
image::images/masters/herod-the-great-fig1-p230.png["Figure from the print edition (pdf p. 230); placement to be confirmed against the PDF",pdfwidth=85%,align=center]
...
// FIGURE: missing table — prose asks which manuscript tradition "carries the most weight" and the next paragraph says "In every single metric the older 22nd year manuscripts win"; the comparison table is not present in the source (likely images/masters/herod-the-great-fig2-p234.jpg)
image::images/masters/herod-the-great-fig2-p234.jpg["Figure from the print edition (pdf p. 234); placement to be confirmed against the PDF",pdfwidth=85%,align=center]
