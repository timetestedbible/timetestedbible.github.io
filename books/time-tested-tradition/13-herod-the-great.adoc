...
.The two candidate eclipses, drawn from the catalog elements: the 4 BC partial grazes a third of the moon at the shadow's southern edge; the 1 BC near-central total darkens it for 99 minutes
image::images/masters/herod-eclipses-4bc-1bc.svg["The 4 BC partial and 1 BC total lunar eclipses, redrawn in grayscale from the NASA/GSFC lunar eclipse catalog elements",pdfwidth=100%,align=center]
