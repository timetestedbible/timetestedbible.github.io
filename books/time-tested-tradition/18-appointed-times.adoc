...
The chapters before this one carry the proofs of the calendar those feasts run on — when the day, the month, and the year begin.
This chapter is about the feasts themselves: what the LORD appointed and how to keep it, whatever day your reckoning lands it on.
What follows is an outline of the key appointed times that you will want to observe as a sign that the LORD is your Elohim (God).
...
The Hebrew word _yom_ is typically translated __“day,”__ but its range is wider than one English word: the daylight as opposed to the night, the 24-hour period, an abstract division or span of time, a year, even a lifetime.
With that range in view, a week ending with a daylight of rest can itself be called a __“day”__ — an abstract division of time.
With this context, it makes sense why Exodus 20 mentions all seven days.
You could therefore translate it as:

[quote.scripture, Exodus 20:8-11, interpretive rendering]
____
...
[quote.scripture, Leviticus 16:15-19, AKJV]
____
...
[quote.scripture, Leviticus 16:27-34, AKJV]
____
