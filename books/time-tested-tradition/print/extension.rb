# Asciidoctor extension for the print build of "Time Tested Tradition" (forked from the MEAT pipeline 2026-07-12).
#
...
class TradePdfConverter < Asciidoctor::PDF::Converter
  ...
  # [[book, [["1:16", [[208, [false, 5]], [214, [true, 16]]]], ...]], ...] — each
  ...
  CHAPTER_PLATES = {
    ...
    'passion-week' => 'images/print/14-before-pilate.jpg',
...
def ink_chapter_title node, title, opts = {}
    ...
    # itself as "16 · Title" (numbered_title — see ChapterNumberTreeprocessor)
    # so the Contents and the PDF outline carry the number; the opener strips
    # that prefix here and draws a small CHAPTER 16 kicker above the title
...
# "16 · Title" through a numbered_title override: asciidoctor-pdf reads
...
# The big opener title strips the prefix and draws a CHAPTER 16 kicker instead
