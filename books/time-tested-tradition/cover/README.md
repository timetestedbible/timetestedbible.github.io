...
- `cover-jacket-sun-moon.svg` is the editable full-jacket source.
...
- `ttt-isbn-9781736521175-barcode.svg` and `.png` are the second edition's Bookland EAN-13 barcode assets.
