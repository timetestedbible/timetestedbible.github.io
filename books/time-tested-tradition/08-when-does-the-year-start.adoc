...
The reason for this is because scripture says “_they are not too difficult for you_”.
...
A result only possible by calculation and if your calendar is indifferent to the need for barley ripeness.
