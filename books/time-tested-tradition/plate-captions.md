# Plate Plaque Captions — TTT 2nd ed — DRAFT — author reviews inscriptions before plates ship

One row per print chapter plate (`images/masters/<stem>.jpg`). Inscription ≤ 7 words,
set in caps on the plaque, DESCRIBING THE PICTURE (author's ruling 2026-07-11);
citation beneath at reduced size. Same compositor pipeline as MEAT
(print/plate-plaques.py to be copied when generation begins). The preface,
