...
out eyes), **5**; *ivvaron/avveret* H5788 (blindness), **3**; *sanverim*
H5575 (a striking-blindness), **2** (Gen 19:11; 2 Kgs 6:18). Greek
*typhlos* G5185, **48 verses**; the verb *typhloō* G5186, **3** (John
12:40; 2 Cor 4:4; 1 John 2:11). The Hebrew Gospels render *typhlos* as
*ivver* at every checked site (Matt 15:14 ×4; 23:16, 24) — one lexeme
across both testaments, round trip confirmed. Adjacent structural texts
that carry the figure without the lexeme are flagged below as such
(Isa 6:10 "shut their eyes"; Isa 29:10; Isa 44:18; Ps 69:23; and
...
with madness, and **blindness** (*ivvaron*), and astonishment of heart:
And thou shalt **grope at noonday**, as the **blind** (*ivver*) gropeth
in darkness (*afelah*), and thou shalt **not prosper in thy ways**."
Blindness is the lamp gone dark: the eye is "the lamp of the body"
(Matt 6:22 — Greek *lychnos*, HG *ner*), the commandment is the lamp
and the law the light (Prov 6:23; Ps 119:105), and the lamp's whole
work is the **way** (feet, path, walking). The blind man is the man
whose ways have gone dark — HG Matt 6:23 says it in the curse's own
vocabulary: "if the light that is in you grows dark, **all your ways
...
and it is the Old Testament text the New quotes most widely: Matt
13:14–15; John 12:40 ("he hath **blinded** their eyes," *typhloō*);
Acts 28:26–27. The sealing follows refusal: "they shall walk like
**blind** men, **because they have sinned** against the LORD" (Zeph
1:17); "the LORD hath poured out upon you the spirit of deep sleep,
and hath closed your eyes" so the whole vision becomes "a book that is
sealed" (Isa 29:9–12). Romans 11 carries the doctrine (7, 25) — KJV
"blindness in part is happened to Israel," though the Greek there is
*pōrōsis*, hardening; the eye-language of the same argument is Ps
69:23, "let their eyes be darkened," quoted at Rom 11:10. History then
staged it: the last thing Zedekiah saw was his sons slain; then Babylon
"put out the eyes" of the king of Judah (*avar* — 2 Kgs 25:7; Jer
39:7; 52:11), and the kingdom went into exile behind a blinded head.

## Blind guides (the leaders)

- "His **watchmen are blind**: they are all ignorant… sleeping, lying
  down, loving to slumber… they all look to their own way, every one
  for his gain" (Isa 56:10–11) — blind watchmen, blinded by gain (the
  bribe-mechanism again).
- "They have wandered as **blind** men in the streets, they have
  polluted themselves with blood" — said of "her prophets and her
  priests, that have shed the blood of the just" (Lam 4:13–14).
- "Let them alone: they be **blind leaders of the blind**. And if the
  ...
  The HG of Matt 23:16 reads "**council** (*moshav* — seat) **of the
  blind**" — the blind occupying the seat — and 23:24 "offspring of
  blind guides"; the five woes of Matt 23 (16, 17, 19, 24, 26) hammer
  one title: *blind guides, blind fools, blind Pharisee*.
- The self-awarded title inverted: "thou… art confident that thou
  thyself art **a guide of the blind**" (Rom 2:19).
- Corrupt worship offers its own condition on the altar: "if ye offer
  the **blind** for sacrifice, is it not evil?" (Mal 1:8; Lev 22:22;
  Deut 15:21).
- Torah embeds the blind-guide curse in advance: "Cursed be he that
  maketh the **blind** to **wander out of the way**" (Deut 27:18; Lev
  19:14) — the way again.

## The worst case: "we see"

- "For judgment I am come into this world, that they which see not
  might see; and that they which see might be made blind… **If ye were
  blind, ye should have no sin: but now ye say, We see; therefore your
  sin remaineth**" (John 9:39–41).
- "Thou sayest, I am rich… and knowest not that thou art wretched, and
  miserable, and poor, and **blind**, and naked" (Rev 3:17).
- "He that lacketh these things is **blind**, and cannot see afar off,
  and **hath forgotten that he was purged** from his old sins"
  (2 Pet 1:9).

Claimed sight seals the condition; confessed blindness is the one form
the Healer can work with.

## The sign of the Messiah

Opening blind eyes is reserved to the LORD as a signature: "Who hath
made man's mouth?… or who maketh the seeing, **or the blind**? have
not I the LORD?" (Ex 4:11); "The LORD **openeth the eyes of the
blind**" (Ps 146:8). The restoration texts make it the mark of the day
of healing: "the eyes of the blind shall see **out of obscurity**
(*choshek* — out of the darkness)" (Isa 29:18); "Then the eyes of the
blind shall be opened" (Isa 35:5); the Servant is sent "to open the
blind eyes" and "bring the blind by a way that they knew not" (Isa
42:7, 16); the gathered remnant includes "the blind and the lame"
(Jer 31:8). Jesus claims the office in those words (Luke 4:18 —
"recovering of sight to the blind"; Matt 11:5 — the answer to John),
performs it in every Gospel, and stages its meaning:

- **John 9** — clay from the ground, then "wash in the pool of Siloam,
  which is by interpretation, **Sent**": sight comes by obeying the
  Sent One; the man's confession grows as his sight does (a man…
  a prophet… of God… Lord, I believe).
- **Mark 8:22–25** — the two-stage healing ("I see men as trees,
  walking") staged between Jesus' two questions about who men say he
  is: partial sight is a real, diagnosable state.
- **Matt 21:14** — "the **blind** and the lame came to him **in the
  temple**; and he healed them" — the deliberate reversal of the
  Jebusite taunt, "the blind and the lame shall not come into the
  house" (2 Sam 5:6–8).
- **Luke 14:13, 21** — the blind are summoned to the feast the
  original guests refused.
- **2 Kgs 6:18–20** — the enemy army struck with *sanverim*, led by
  the prophet to Samaria, and there "the LORD opened their eyes":
  blindness as a leading-into-mercy, ending at a feast instead of a
  slaughter.
- **Acts 13:11** — Elymas, "full of all subtilty," struck blind "for
  a season," groping for a hand to lead him: the adversary's blindness
  given a time limit — the same shape as "blindness in part…
  **until** the fulness of the Gentiles" (Rom 11:25).
- **Gen 19:11** — Sodom's men, struck with *sanverim*, "wearied
  themselves to find **the door**" — the groping of the blind aimed at
  the one exit they refused.

## Counter-texts weighed

- **Literal blindness** is real throughout (Bartimaeus, John 5:3), and
  the law's mercy-commands guard literal blind men (Lev 19:14). The
  literal cases carry the figure rather than compete with it — every
  healing is enacted doctrine, and the blemish laws (Lev 21:18; Mal
  1:8) preach with the literal condition.
- **Isa 42:19** — "Who is blind, but my servant?… who is blind as he
  that is perfect (*meshullam*)?" The hard text of the set: the
  Servant wears the nation's blindness in the same oracle that sends
  him to open blind eyes (42:7). Read within the range: the blind
  servant is the covenant nation failing its watchman office (43:8,
  "the blind people **that have eyes**"), and the Servant who heals
  takes the title to carry it away. Flagged as the passage requiring
  the most care; no reading here is claimed beyond the range.
...
(Deut 28:29 — the groping hour), Door (Gen 19:11).
