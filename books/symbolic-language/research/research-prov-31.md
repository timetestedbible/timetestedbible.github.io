...
| 14 | "the merchandise of it is better than the merchandise of silver, and the gain thereof than fine gold" | כִּי טוֹב סַחְרָהּ, מִסְּחַר, חָרוּץ, תְּבוּאָתָהּ | כי טוב סחרה = **Prov 31:18 letter for letter** (headline above). *Sachar* H5504/H5505 from H5503, "to travel round" — the circuit-trade note, same as ch. 31 (no sahar/crescent claim). *Charuts* H2742 is a genuine homograph bundle: "a trench (as dug), **gold** (as mined), a **threshing-sledge**, determination" — the same word the book already handled at Dan 9:25 ("the moat"); "her increase better than the threshing-sledge" is attested letters but adds nothing lunar: noted, not claimed. *Tevu'ah* H8393 = increase, produce, harvest. | headline weld **definitional**; charuts noted only |
...
| 18 | "a tree of life to them that lay hold upon her: and happy is every one that retaineth her" | לַמַּחֲזִיקִים, וְתֹמְכֶיהָ, מְאֻשָּׁר | *Tamak* H8551 — the same verb as Prov 31:19, "her hands **hold** the pelek": there her palms hold the circuit; here the blessed hold *her*. *Me'ushar* — the *ashar* root again, closing the inclusio opened by v13's אשרי, the verb of Prov 31:28 (and of Asher's naming, Gen 30:13). Tree of life → the Trees chapter's symbol; not re-derived here. | tamak weld strong; ashar inclusio structural |
...
- **v14** — *sachar*-family words rendered by the root's own sense, H5503 "to travel round";
  plain: "merchandise" (twice). *Tevu'ah* H8393 "increase, fruits" — "harvest"; plain: "gain."
