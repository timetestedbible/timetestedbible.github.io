...
class TradePdfConverter < Asciidoctor::PDF::Converter
  ...
  def convert_table node
    ...
    # 2026-07-18 — "a 1 page table"; it had grown past the page since the
    # 19-row fitting): scope the table metrics down for that table alone.
    # Wrapped before the scratch return so dry-run measurements and the real
    # render see the same geometry.
  ...
  SX_COLUMNS         = 4       # 4 dense columns (author, 2026-07-20): index 18pp -> 14pp
  ...
  def balance_prose_paragraph node
    ...
    # one truly fits, and single lines strand (found via TTT's p. 44 orphan,
    # 2026-07-13; same fix applied in both books).
    ...
    if first_h < min_chunk
      ...
      # Half-a-line of slack on the pull and the keep-side guard (see min_chunk
      # note above — the computed line height undershoots the real advance).
  ...
  CHAPTER_PLATES = {
    ...
    'wings'                 => 'images/print/13-hem.jpg',
    'orphans-widows-and-the-fatherless' => 'images/print/14-widow-door.jpg',
    'the-remnant'           => 'images/print/15-olive-gleanings.jpg',
    'heaven-and-hell'       => 'images/print/16-furnace.jpg',
    'justice-and-judgment'  => 'images/print/18-gate-judgment.jpg',
    'liberty'               => 'images/print/19-jubilee.jpg',
    ...
    'the-bow'               => 'images/print/44-covenant-bow.jpg',
    ...
    'the-fool-and-the-wise' => 'images/print/20-fool-and-wise.jpg',
    'light-and-darkness'    => 'images/print/21-lamp-stand.jpg',
