...
function getVirgoMethodologyHtml(options = {}) {
  ...
  html += `<details class="settings-accordion" style="margin-top: 12px;"><summary>View Methodology Explanation</summary>
      <div class="accordion-content">
        ...
        <p><a href="https://thecreatorscalendar.com" target="_blank" style="color: var(--accent-primary);">TheCreatorsCalendar.com</a> and <a href="https://www.youtube.com/@MikalShabbat" target="_blank" style="color: var(--accent-primary);">Mikal Shabbat Scriptural Studies</a> also teach the moon-under-Virgo's-feet year start, each on its own line of reasoning. The Hebrew-text argument above — Virgo ranked <em>first of the twelve</em> — is the contribution of <em>Time Tested Tradition</em>, 2nd edition, which adopts the rule with first-light day boundaries.</p>
      </div></details>
